...
### irule -F dmput.r "*dataPath='/nfsDirectoryPath/home/user1/testFileName /nfsDirectoryPath/home/user1/testFileTwo'"

arcStatus{

    msiExecCmd("dmput", *dataPath, "resource.server.fqdn.goes.here", "", "", *dmRes);
