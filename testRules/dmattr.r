...
### irule -F dmattr.r "*dataPath='/nfsDirectoryPath/home/user1/testFileName /nfsDirectoryPath/home/user1/testFileTwo'"

arcStatus{

    msiExecCmd("dmattr", *dataPath, "resource.server.fqdn.goes.here", "", "", *dmRes);
